 ...
 */
public class KeyMapReplacerTest {

    private TestRunner testRunner;

    @BeforeEach
    public void init() {
        testRunner = TestRunners.newTestRunner(KeyMapReplacer.class);
    }

    @Test
    public void outputTesterClosedList() throws IOException {
        /* Read the content of a sample JSON file */
        String jsonString = "{\"key1\": \"value1\", \"key2\": \"2012\", \"key3\": \"six\"}";

        /* Adding properties */
        testRunner.setProperty(KeyMapReplacer.CONST_MAP_KEYS, "six,2012,value1");
        testRunner.setProperty(KeyMapReplacer.CONST_MAP_VALUES, "red,yellow,set");
        testRunner.setProperty(KeyMapReplacer.KEY_TO_CHECK, "key1");
        testRunner.setProperty(KeyMapReplacer.NEW_KEY_NAMES, "key1");
        ...
        List<MockFlowFile> mockFlowFileList = testRunner.getFlowFilesForRelationship(KeyMapReplacer.REL_SUCCESS);
