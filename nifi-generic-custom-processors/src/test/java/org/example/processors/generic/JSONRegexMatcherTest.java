 ...
 */
public class JSONRegexMatcherTest {

    private TestRunner testRunner;

    @BeforeEach
    public void init() {
        testRunner = TestRunners.newTestRunner(JSONRegexMatcher.class);
    }

    @Test
    public void outputTesterJsonRegexMatcher() throws IOException {
        /* Read the content of a sample JSON file */
        String jsonString = "{\"name\": \"John Doe\", \"age\": 30, \"email\": \"667620008451602022-02-0817:54P03\"}";

        /* Adding properties */
        testRunner.setProperty(JSONRegexMatcher.REGEX, "\\w+");
        testRunner.setProperty(JSONRegexMatcher.JSON_FIELD, "email");
        ...
        List<MockFlowFile> mockFlowFileList = testRunner.getFlowFilesForRelationship(JSONRegexMatcher.REL_SUCCESS);
