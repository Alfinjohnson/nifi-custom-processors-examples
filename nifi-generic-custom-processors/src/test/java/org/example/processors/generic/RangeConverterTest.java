...
public class RangeConverterTest {
    ...
    @BeforeEach
    public void init() {
        testRunner = TestRunners.newTestRunner(RangeConverter.class);
    }

    @Test
    public void outputTesterRangeConverter() throws IOException {
        /* Read the content of a sample JSON file */
        String jsonString = "{\"AA\": \"0.705342\", \"BB\": 3.8}";

        /* Adding properties */
        testRunner.setProperty(RangeConverter.SpecifiedKey, "AA");
        testRunner.setProperty(RangeConverter.SpecifiedNewKey, "icc_key");
        ...
        List<MockFlowFile> mockFlowFileList = testRunner.getFlowFilesForRelationship(RangeConverter.REL_SUCCESS);
