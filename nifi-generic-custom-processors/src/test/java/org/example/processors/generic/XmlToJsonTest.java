...
public class XmlToJsonTest {
    ...
    @BeforeEach
    public void init() {
        testRunner = TestRunners.newTestRunner(XmlToJson.class );
    }

    @Test
    public void outputTesterXmlToJson() {
        /* Read the content of a sample JSON file */
        String jsonString = "<Event xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\">\n" +
                "<GeneralInformation>\n" +
                "<EventType>Registration</EventType>\n" +
                "<Participant Source=\"Target\">\n" +
                "<Identifier>sony1</Identifier>\n" +
                "</Participant>\n" +
                "</GeneralInformation>\n" +
                "</Event>";
        ...
        List<MockFlowFile> mockFlowFileList = testRunner.getFlowFilesForRelationship(XmlToJson.REL_SUCCESS);
